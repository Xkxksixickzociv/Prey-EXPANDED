...
-----------------------------------------------------------------------
	...
	--------CODING CREW--------
	--CODER 1
	makeLuaText('CODER1', 'Resai', 1000, 132, -1000)
	setTextAlignment('CODER1', 'center')
	setTextSize('CODER1', 25)
	setObjectCamera('CODER1', 'other')
	addLuaText('CODER1')

	makeLuaText('CODER2', 'Original EXE Devs', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'AnarakWarriors', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Zeroh', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'Unknown', 1000, 132, -1000)
