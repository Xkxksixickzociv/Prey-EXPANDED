...
function onStepHit()
    ...
    if curStep == 640 then
        doTweenX('furnaceClose1','dad',500,1.5,'linear')
    end
	
	 if curStep == 655 then
        doTweenX('furnaceClose2','dad',0,1,'quartInOut')
    end
...
if curStep == 703 then
    ...
    if curStep == 2448 then
	 ...
	 if curStep == 2888 then
        doTweenX('byeEggHead','dad',-500,2.5,'linear')
    end
	
	if curStep == 3072 then
        doTweenX('helloEggHead','dad',1100,2,'linear')
    end
