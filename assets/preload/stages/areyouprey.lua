...
function onCreate()
 ...
 makeLuaSprite('stardustBg', 'starved/stardustBg3', -1000, -750);
 ...
 setLuaSpriteScrollFactor('stardustBg', 1, 1);
  ...
  makeLuaSprite('stardustBg2', 'starved/stardustBg4', 3600, -750);
 ...
 makeLuaSprite('stardustFloor', 'starved/stardustFloor1BF', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor', 1, 1);
  ...
  makeLuaSprite('stardustFloor2', 'starved/stardustFloor2BF', 3600, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor2', 1, 1);
  ...
  makeLuaSprite('stardustFloor5', 'starved/stardustFloor5BF', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor5', 1, 1);
  ...
  makeLuaSprite('stardustFloor6', 'starved/stardustFloor6BF', 3600, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor6', 1, 1);
  ...
  makeLuaSprite('stardustFloor3', 'starved/stardustFloorDIALOGUE', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor3', 1, 1);
  ...
  makeLuaSprite('stardustFloor4', 'starved/stardustFloorDIALOGUE2', 3600, -1460);
