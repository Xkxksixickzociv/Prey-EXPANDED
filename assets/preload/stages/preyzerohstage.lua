...
function onCreate()
 ...
 makeLuaSprite('stardustBg', 'starved/stardustBg3PRE', -1000, -750);
 ...
 setLuaSpriteScrollFactor('stardustBg', 1, 1);
  ...
  makeLuaSprite('stardustBg2', 'starved/stardustBg4PRE', 3600, -750);
 ...
 makeLuaSprite('stardustFloor', 'starved/stardustFloor1PRE', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor', 1, 1);
  ...
  makeLuaSprite('stardustFloor2', 'starved/stardustFloor2PRE', 3600, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor2', 1, 1);
  ...
  makeLuaSprite('stardustFloor5', 'starved/stardustFloor5PRE', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor5', 1, 1);
  ...
  makeLuaSprite('stardustFloor6', 'starved/stardustFloor6PRE', 3600, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor6', 1, 1);
  ...
  makeLuaSprite('stardustFloor3', 'starved/stardustFloorDIALOGUEPRE', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor3', 1, 1);
  ...
  makeLuaSprite('stardustFloor4', 'starved/stardustFloorDIALOGUEPRE2', 3600, -1460);
...
function onStepHit()
  if curStep == 128 then --background becomes visible
  ...
  if curStep == 1545 then --seems like that bucket of bolts had to lay off the nitro this time around!
    setProperty('stardustFloor.visible', false);
    setProperty('stardustFloor2.visible', false);
  ...
  if curStep == 1791 then --speed up at starved part
    setProperty('stardustFloor.visible', true);
    setProperty('stardustFloor2.visible', true);
    setProperty('stardustFloor3.visible', false);
    setProperty('stardustFloor4.visible', false);
