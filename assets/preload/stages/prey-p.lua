...
function onCreate()
 ...
 makeLuaSprite('stardustBg', 'starved/stardustBg3P', -1000, -750);
 ...
 setLuaSpriteScrollFactor('stardustBg', 1, 1);
  ...
  makeLuaSprite('stardustBg2', 'starved/stardustBg4P', 3600, -750);
 ...
 makeLuaSprite('stardustFloor', 'starved/stardustFloor1P', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor', 1, 1);
  ...
  makeLuaSprite('stardustFloor2', 'starved/stardustFloor2P', 3600, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor2', 1, 1);
  ...
  makeLuaSprite('stardustFloor5', 'starved/stardustFloor5P', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor5', 1, 1);
  ...
  makeLuaSprite('stardustFloor6', 'starved/stardustFloor6P', 3600, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor6', 1, 1);
  ...
  makeLuaSprite('stardustFloor3', 'starved/stardustFloorDIALOGUEP', -1000, -1460);
 ...
 setLuaSpriteScrollFactor('stardustFloor3', 1, 1);
  ...
  makeLuaSprite('stardustFloor4', 'starved/stardustFloorDIALOGUEP2', 3600, -1460);
...
function onStepHit()
  ...
  if curStep == 1546 then --seems like that bucket of bolts had to lay off the nitro this time around!
    setProperty('stardustFloor.visible', false);
    setProperty('stardustFloor2.visible', false);
